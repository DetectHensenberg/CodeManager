...
toolbar(hasPriv('ai', 'miniPrograms') ? item(set(array(
    'type' => 'primary',
    ...
    return a(
        ...
        div(
            ...
            div(
                ...
                btn(setClass('btn-avatar'), setStyle(array(
                    'width'            => '46px',
                    'height'           => '46px',
                    'border-radius'    => '50%',
                    'display'          => 'flex',
...
{
    div(setClass('miniprogram-container'), array_map($miniProgramCard, $miniPrograms));
}
