...
h::table(setClass('table bordered bg-white text-center'), h::tr
(
    h::td
    (
...
), h::tr(h::td($lang->weekly->ev), h::td($ev)), h::tr(h::td($lang->weekly->ac), h::td($ac)), h::tr(h::td($lang->weekly->sv), h::td($sv ? $sv . '%' : '')), h::tr
(
    h::td($lang->weekly->cv),
    h::td($cv ? $cv . '%' : ''),
