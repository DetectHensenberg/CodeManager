<?php
/**
 * The html detail.html.php view file of bug module of ZenTaoPMS.
 * Design: 18-Bug-详情
 *
...
<header class="topbar"><div class="search-top">⌕ <span>搜索Bug、负责人、状态、编号...</span></div><div class="top-actions"><button class="icon-btn">●</button><button class="icon-btn">!</button><button class="primary-btn">＋ 新建Bug</button><div class="user"><span class="avatar"><?php echo $userInitial; ?></span><span><?php echo $userName; ?></span><span style="color:#6e789f">⌄</span></div></div></header>
    ...
    <section class="detail-layout"><div>
      <article class="detail-block"><div class="panel-head"><div><h2 class="panel-title">产品列表横向溢出</h2><p class="caption">Bug编号 BUG-2026-001 · 负责人 admin · 更新时间 2026-04-28</p></div><span class="status">进行中</span></div><div class="kv"><div class="kv-item"><div class="kv-label">进度</div><div class="kv-value">76%</div></div><div class="kv-item"><div class="kv-label">优先级</div><div class="kv-value">高</div></div><div class="kv-item"><div class="kv-label">截止日期</div><div class="kv-value">2026-05-18</div></div></div></article>
      <article class="detail-block rich"><h3>目标与范围</h3><p>Bug 详情记录复现环境、步骤、实际结果和期望结果。</p><h3>验收标准</h3><p>解决后需要测试验证并保留修复记录。</p><ul><li>关键路径清晰，状态变化可追踪。</li><li>表格、按钮、弹窗在深色背景下保持可读。</li><li>所有关联对象保留可进入详情的操作。</li></ul><h3>关联对象</h3><p>关联影响版本、用例和代码提交。</p></article>
