...
class upgrade extends control
{
     ...
     * @return void
     */
    public function license($agree = 0)
    {
     ...
     * @return void
     */
    public function ajaxExecute($fromVersion, $toVersion)
    {
        session_write_close();
     ...
     * @return void
     */
    public function consistency($netConnect = 1)
    {
        $logFile  = $this->upgrade->getConsistencyLogFile();
     ...
     * @param string $processed
     */
    public function upgradeDocs($fromVersion = '', $processed = 'no')
    {
     ...
     * @return void
     */
    public function ajaxUpgradeDoc($docID)
    {
     ...
     * @return void
     */
    public function upgradeDocTemplates($fromVersion = '', $processed = 'no')
    {
        $this->loadModel('doc');
     ...
     * @return void
     */
    public function ajaxUpgradeDocTemplate($docID)
    {
     ...
     * @return void
     */
    public function upgradeProjectReports($fromVersion = '', $processed = 'no')
    {
