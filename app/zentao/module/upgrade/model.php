...
class upgradeModel extends model
{
     ...
     * @return array
     */
    public function getOtherMethods($fromEdition)
    {
        $methods = [];
     ...
     * @return bool
     */
    public function recordExecutedChanges()
    {
     ...
     * @return bool
     */
    public function execute($fromVersion, $toVersion)
    {
        set_time_limit(0);
     ...
     * @return bool
     */
    public function executeOthers($fromEdition)
    {
     ...
     * @return bool
     */
    public function executeUpgradeMethod($version, $rawMethod, $params = [])
    {
     ...
     * @return string
     */
    public function deleteFiles($script)
    {
        $dir = dirname($script);
     ...
     * @return bool
     */
    public function execSQL($sqlFile, $version = '')
    {
     ...
     * @return array
     */
    public function removeEncryptedDir($script)
    {
        $dir = dirname($script);
        if(!is_writable($dir)) return "chmod 777 {$dir}";
     ...
     * @return int
     */
    public function addDeliverable($name, $deliverable, $deliverableStage, &$nameFilter = array())
    {
        /* 重名的交付物名称后面加数字。 */
     ...
     * @return int
     */
    public function createDeliverableModule($workflowGroupID, $name, $extra = '')
    {
        $module = new stdclass();
     ...
     * @return void
     */
    public function createOtherDeliverable($workflowGroupID)
    {
     ...
     * @return int
     */
    public function createOtherActivity($moduleID, $workflowGroupID)
    {
     ...
     * @return bool
     */
    public function createTestcaseDeliverable($modules)
    {
     ...
     * @return bool
     */
    public function deleteTestcaseDeliverable($modules)
    {
        foreach($modules as $key => $name)
        {
     ...
     * @return bool
     */
    public function changeTestcaseDeliverable($modules)
    {
        foreach($modules as $key => $name)
        {
     ...
     * @return void
     */
    public function upgradeProjectDeliverable($deliverableList)
    {
     ...
     * @param object $file
     */
    public function moveFileToDoc($project, $projectMainLibPairs, $executionMainLibPairs, $file)
    {
     ...
     * @return array
     */
    public function getUpgradeProjectReports()
    {
     ...
     * @return bool
     */
    public function upgradeProjectReport($data)
    {
        $report = new stdclass();
     ...
     * @return bool
     */
    public function upgradeReviewclCategory()
    {
        $this->loadModel('custom');
        $clientLang   = $this->app->getClientLang();
     ...
     * @return bool
     */
    public function checkExistAIPrompt($aiPrompt)
    {
     ...
     * @return bool
     */
    public function alterUserTableFields()
    {
     ...
     * @return bool
     */
    public function initAIPromptFields($aiPromptFields, $promptID)
    {
     ...
     * @return bool
     */
    public function updateWorkflowGroupPriv()
    {
     ...
     * @return bool
     */
    public function upgradeReportTemplateObjects()
    {
     ...
     * @return bool
     */
    public function disableFeaturesByMode()
    {
