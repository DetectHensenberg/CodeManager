...
class upgradeTao extends upgradeModel
{
     ...
     * @return array
     */
    protected function handleBuildinWorkflowGroup($group, $groupID, $classifyModule)
    {
     ...
     * @return array
     */
    protected function migrateClassifyToModule($group, $groupID)
    {
     ...
     * @return int
     */
    protected function createProcessModule($groupID, $key, $name, $order)
    {
        $module = new stdclass();
        $module->root   = $groupID;
        $module->branch = '0';
     ...
     * @param array  $classifyModule 分类模块数组
     */
    protected function handleNeedCopyWorkflowGroup($group, $groupID, $classifyModule)
    {
     ...
     */
    protected function copyProcessWithActivities($process, $groupID, $activityGroup, $outputGroup, $projectIdList)
    {
     ...
     * @param array  $projectIdList 项目ID列表
     */
    protected function copyActivity($activity, $processID, $groupID, $outputGroup, $projectIdList)
    {
     ...
     * @return void
     */
    public function migrateOutputToDeliverable($group)
    {
     ...
     */
    protected function updateProcessModules($classifyModule)
    {
