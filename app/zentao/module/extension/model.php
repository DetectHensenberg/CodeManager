...
class extensionModel extends model
{
     ...
     * @return array
     */
    public function getDependsExtension($extension)
    {
     ...
     * @return array
     */
    public function getExpiringPlugins($isGroup = false)
    {
     ...
     * @return bool
     */
    public function saveExtension($code, $type)
    {
        //从插件包中获取配置信息。
     ...
     * @return array
     */
    private function removeExtensionFiles($files)
    {
        $commandTips = array();
        $appRoot     = $this->app->getAppRoot();
     ...
     * @return array
     */
    private function removeExtensionDirs($dirs)
    {
        $commandTips = array();
        $appRoot     = $this->app->getAppRoot();
