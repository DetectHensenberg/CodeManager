<?php
/**
 * The html detail.html.php view file of task module of ZenTaoPMS.
 * Design: 16-任务-详情
 *
...
<div class="cm-page cm-page-task-detail">
...
<header class="topbar"><div class="search-top">⌕ <span>搜索任务、负责人、状态、编号...</span></div><div class="top-actions"><button class="icon-btn">●</button><button class="icon-btn">!</button><button class="primary-btn">＋ 新建任务</button><div class="user"><span class="avatar"><?php echo $userInitial; ?></span><span><?php echo $userName; ?></span><span style="color:#6e789f">⌄</span></div></div></header>
    <section class="hero"><div><div class="crumbs"><span>任务</span><span>›</span><span>详情</span></div><h1>任务详情</h1><p class="subtitle">任务说明、工时记录、子任务和操作历史。</p></div><button class="ghost-btn">更多操作 ⌄</button></section>
    <section class="detail-layout"><div>
      <article class="detail-block"><div class="panel-head"><div><h2 class="panel-title">生成核心页面 HTML</h2><p class="caption">任务编号 任务-2026-001 · 负责人 admin · 更新时间 2026-04-28</p></div><span class="status">进行中</span></div><div class="kv"><div class="kv-item"><div class="kv-label">进度</div><div class="kv-value">76%</div></div><div class="kv-item"><div class="kv-label">优先级</div><div class="kv-value">高</div></div><div class="kv-item"><div class="kv-label">截止日期</div><div class="kv-value">2026-05-18</div></div></div></article>
      <article class="detail-block rich"><h3>目标与范围</h3><p>任务说明实现目标、工作拆分和交付结果。</p><h3>验收标准</h3><p>工时记录、子任务和状态流转必须清晰。</p><ul><li>关键路径清晰，状态变化可追踪。</li><li>表格、按钮、弹窗在深色背景下保持可读。</li><li>所有关联对象保留可进入详情的操作。</li></ul><h3>关联对象</h3><p>关联需求、提交、Bug 和文档。</p></article>
