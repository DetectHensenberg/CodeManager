...
class taskZen extends task
{
     ...
     * @return array
     */
    protected function responseAfterEdit($taskID, $from, $changes, $message = '')
    {
     ...
     * @return array
     */
    protected function responseModal($task, $from, $message = '')
    {
        $response['result']     = 'success';
        $response['message']    = $message ?: $this->lang->saveSuccess;
     ...
     * @return array
     */
    protected function responseAfterChangeStatus($task, $from, $message = '')
    {
        $message = $message ?: $this->lang->saveSuccess;
        if($this->viewType == 'json' || (defined('RUN_MODE') && RUN_MODE == 'api')) return array('result' => 'success');
