...
class docZen extends doc
{
     ...
     * @return object
     */
    protected function assignVarsForUploadDocs($docID, $objectType, $objectID, $libID, $moduleID = 0, $docType = '')
    {
     ...
     * @return array
     */
    protected function responseAfterEdit($doc, $changes = array(), $files = array(), $deletedFiles = array())
    {
