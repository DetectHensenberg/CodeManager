...
elseif($module == 'feedback' && $field == 'review')
{
    ...
    $formItems[] = formGroup(set::width('1/2'), set::labelWidth($labelWidth), set::hidden($needReview), set::label($lang->custom->forceReview), set::name('forceReview[]'), set::value($forceReview), set::control('picker'), set::items($users), set::multiple(true), set::tip(sprintf($lang->custom->notice->forceReview, $lang->feedback->common)));
    $formItems[] = formGroup(set::width('1/2'), set::labelWidth($labelWidth), set::hidden(!$needReview), set::label($lang->custom->forceNotReview), set::name('forceNotReview[]'), set::value($forceNotReview), set::control('picker'), set::items($users), set::multiple(true), set::tip(sprintf($lang->custom->notice->forceNotReview, $lang->feedback->common)));
