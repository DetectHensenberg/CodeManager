...
formPanel(set::title($title), set::headingClass('justify-start'), set::bodyClass('px-0'), set::submitBtnText($lang->convert->jira->next), set::backUrl(inlink('index')), to::heading
(
    span
    (
...
) : null, in_array($method, ['file', 'api']) ? formGroup
(
