...
class convertTao extends convertModel
{
     ...
     * @return bool
     */
    protected function importJiraChangeItem($dataList, $changeGroups = array())
    {
        $issueList = $this->getIssueData();
     ...
     * @return int
     */
    protected function createSystem($productID)
    {
     ...
     * @return object
     */
    public function processBuildinFieldData($module, $data, $object, $relations, $customFields, $buildinFlow = false)
    {
     ...
     */
    protected function createStory($productID, $projectID, $executionID, $type, $data, $relations, $customFields)
    {
     ...
     * @return bool
     */
    protected function createTask($projectID, $executionID, $data, $relations, $customFields)
    {
     ...
     * @return bool
     */
    protected function createBug($productID, $projectID, $executionID, $data, $relations, $customFields)
    {
     ...
     * @return bool
     */
    protected function createCase($productID, $projectID, $executionID, $data, $relations, $customFields)
    {
        $this->loadModel('action');
     ...
     * @return bool
     */
    protected function createFeedback($productID, $data, $relations, $customFields)
    {
        $this->loadModel('action');
     ...
     * @return bool
     */
    protected function createTicket($productID, $data, $relations, $customFields)
    {
        $this->loadModel('action');
     ...
     * @return array
     */
    protected function createWorkflow($relations, $jiraActions, $jiraResolutions, $jiraPriList, $jiraStatusList = array())
    {
     ...
     * @return array
     */
    protected function createWorkflowStatus($relations, $jiraStatusList)
    {
        if($this->config->edition == 'open') return $relations;
     ...
     * @return bool
     */
    protected function createGroup($type, $name, $objectList, $jiraProjectID, $zentaoProjectID, $productRelations, $projectFieldList)
    {
        $group = new stdclass();
