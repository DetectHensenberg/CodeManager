...
class stageModel extends model
{
     ...
     * @return bool
     */
    public function batchCreate($groupID = 0, $stages = array())
    {
     ...
     * @return array
     */
    public function getStages($orderBy = 'order_desc', $projectID = 0, $groupID = 0, $grade = 0)
    {
     ...
     * @param int $groupID
     */
    public function getTotalPercent($groupID)
    {
     ...
     *  @return void
     */
    public function addBuiltinPoint($groupID)
    {
     ...
     * @return bool
     */
    public function getStagePoints($type, $stageID)
    {
     ...
     * @param mixed[] $points
     */
    public function setPoint($type, $stageID, $points)
    {
