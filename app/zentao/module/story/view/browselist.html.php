<?php
/**
 * The html browselist.html.php view file of story module of ZenTaoPMS.
 * Design: 13-需求-列表
 *
...
<div class="cm-page cm-page-story-list">

<header class="topbar"><div class="search-top">⌕ <span>搜索需求、负责人、状态、编号...</span></div><div class="top-actions"><button class="icon-btn">●</button><button class="icon-btn">!</button><button class="primary-btn">＋ 新建需求</button><div class="user"><span class="avatar"><?php echo $userInitial; ?></span><span><?php echo $userName; ?></span><span style="color:#6e789f">⌄</span></div></div></header>
    <section class="hero"><div><div class="crumbs"><span>需求</span><span>›</span><span>列表</span></div><h1>需求列表</h1><p class="subtitle">需求池表格、状态筛选、优先级、评审状态和关联计划。</p></div><button class="ghost-btn">视图设置 ⌄</button></section>
    <section class="metrics"><article class="metric"><div class="label">全部</div><div class="hint" style="">+6</div><div class="value">24</div></article><article class="metric"><div class="label">进行中</div><div class="hint" style="">+18%</div><div class="value">12</div></article><article class="metric"><div class="label">风险</div><div class="hint" style="color:var(--yellow)">关注</div><div class="value">3</div></article><article class="metric"><div class="label">完成率</div><div class="hint" style="">+8%</div><div class="value">76%</div></article></section><div class="toolbar"><div class="filters"><span class="filter ">全部</span><span class="filter active">未关闭 <span class="count">4</span></span><span class="filter ">我负责</span><span class="filter ">有风险</span></div><div class="actions"><button class="ghost-btn">⇧ 导出</button><button class="primary-btn">＋ 新建</button></div></div><section class="panel"><div class="table-wrap"><table class="data-table"><thead><tr><th><span class="check">✓</span></th><th>需求名称</th><th>负责人</th><th>所属产品</th><th>优先级</th><th>评审状态</th><th>关联计划</th><th>状态</th><th>操作</th></tr></thead><tbody><tr><td><span class="check">✓</span></td><td><div class="name-main">统一深色表格规范</div><div class="name-sub">需求-001</div></td><td><div class="owner"><span class="mini-avatar"><?php echo $userInitial; ?></span><?php echo $userName; ?></div></td><td class="">CodeManager</td><td class="">高</td><td class="">评审中</td><td class="">UI-DS</td><td><span class="status ">进行中</span></td><td><button class="small-btn">详情</button></td></tr><tr><td><span class="check">✓</span></td><td><div class="name-main">产品看板信息密度优化</div><div class="name-sub">需求-002</div></td><td><div class="owner"><span class="mini-avatar">L</span>lucen</div></td><td class="">Data Platform</td><td class="">中</td><td><span class="status ">激活</span></td><td class="">PLAN-22</td><td><span class="status ">进行中</span></td><td><button class="small-btn">详情</button></td></tr><tr><td><span class="check">✓</span></td><td><div class="name-main">知识库摄取流程</div><div class="name-sub">需求-003</div></td><td><div class="owner"><span class="mini-avatar">K</span>knowledge</div></td><td class="">RAG-KOS</td><td class="">高</td><td class="">草稿</td><td class="">PLAN-23</td><td><span class="status warn">待评审</span></td><td><button class="small-btn">详情</button></td></tr><tr><td><span class="check">✓</span></td><td><div class="name-main">后台安全策略可视化</div><div class="name-sub">需求-004</div></td><td><div class="owner"><span class="mini-avatar">S</span>security</div></td><td class="">Admin</td><td class="">中</td><td class="">变更中</td><td class="">PLAN-24</td><td><span class="status warn">关注</span></td><td><button class="small-btn">详情</button></td></tr></tbody></table></div><div class="footer-row"><span>共 4 项</span><div class="pager"><span>每页 20 项</span><span>1/1</span><span>‹</span><span>›</span></div></div></section><section class="grid-2"><article class="panel pad"><div class="panel-head"><div><h2 class="panel-title">需求洞察</h2><p class="caption">用于辅助负责人快速判断当前优先级。</p></div></div><div class="timeline"><div class="time-item"><span class="time">今日</span><div class="time-body"><strong>高优先级事项集中</strong><span>建议优先处理风险、阻塞和即将到期项。</span></div></div><div class="time-item"><span class="time">本周</span><div class="time-body"><strong>完成率稳步提升</strong><span>主要收益来自统一页面结构和可复用设计组件。</span></div></div></div></article><article class="panel pad"><div class="panel-head"><div><h2 class="panel-title">建议动作</h2><p class="caption">保持与 LucenAI 地盘首页一致的交互语言。</p></div></div><div class="module-grid" style="grid-template-columns:repeat(2,1fr)"><div class="module-card"><h3>补齐状态</h3><p>缺少负责人或截止日期的事项需要优先补全。</p></div><div class="module-card"><h3>同步文档</h3><p>关键决策沉淀到文档空间，方便团队复盘。</p></div></div></article></section>
</div>
