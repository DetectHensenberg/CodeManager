<?php
/**
 * The html detail.html.php view file of story module of ZenTaoPMS.
 * Design: 14-需求-详情
 *
...
<div class="cm-page cm-page-story-detail">
...
<header class="topbar"><div class="search-top">⌕ <span>搜索需求、负责人、状态、编号...</span></div><div class="top-actions"><button class="icon-btn">●</button><button class="icon-btn">!</button><button class="primary-btn">＋ 新建需求</button><div class="user"><span class="avatar"><?php echo $userInitial; ?></span><span><?php echo $userName; ?></span><span style="color:#6e789f">⌄</span></div></div></header>
    <section class="hero"><div><div class="crumbs"><span>需求</span><span>›</span><span>详情</span></div><h1>需求详情</h1><p class="subtitle">需求描述、验收标准、生命周期、关联任务和 Bug。</p></div><button class="ghost-btn">更多操作 ⌄</button></section>
    <section class="detail-layout"><div>
      <article class="detail-block"><div class="panel-head"><div><h2 class="panel-title">统一深色表格规范</h2><p class="caption">需求编号 需求-2026-001 · 负责人 admin · 更新时间 2026-04-28</p></div><span class="status">进行中</span></div><div class="kv"><div class="kv-item"><div class="kv-label">进度</div><div class="kv-value">76%</div></div><div class="kv-item"><div class="kv-label">优先级</div><div class="kv-value">高</div></div><div class="kv-item"><div class="kv-label">截止日期</div><div class="kv-value">2026-05-18</div></div></div></article>
      <article class="detail-block rich"><h3>目标与范围</h3><p>需求描述业务背景、用户目标、范围边界和验收口径。</p><h3>验收标准</h3><p>评审通过后进入计划，并自动拆分任务。</p><ul><li>关键路径清晰，状态变化可追踪。</li><li>表格、按钮、弹窗在深色背景下保持可读。</li><li>所有关联对象保留可进入详情的操作。</li></ul><h3>关联对象</h3><p>关联任务、Bug、用例和产品计划。</p></article>
