...
class storyModel extends model
{
     ...
     * @return array
     */
    public function getStories2Link($storyID, $browseType = 'bySearch', $queryID = 0, $pager = null, $orderBy = 'id_desc')
    {
     ...
     * @return array
     */
    public function getAllChildId($storyID, $includeSelf = true, $sameType = false, $excludeStatus = '')
    {
