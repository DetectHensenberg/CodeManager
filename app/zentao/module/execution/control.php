...
class execution extends control
{
     ...
     * @return void
     */
    public function testtask($executionID = 0, $productID = 0, $orderBy = 'id_desc', $recTotal = 0, $recPerPage = 20, $pageID = 1)
    {
     ...
     * @return void
     */
    public function ajaxGetDropMenu($executionID, $module = 'execution', $method = 'task', $extra = '')
    {
        $execution = $this->execution->fetchByID($executionID);
