<?php
/**
 * The html detail.html.php view file of testreport module of ZenTaoPMS.
 * Design: 21-测试-测试单详情
 *
...
<div class="cm-page cm-page-testreport-detail">
...
<header class="topbar"><div class="search-top">⌕ <span>搜索测试、负责人、状态、编号...</span></div><div class="top-actions"><button class="icon-btn">●</button><button class="icon-btn">!</button><button class="primary-btn">＋ 新建测试</button><div class="user"><span class="avatar"><?php echo $userInitial; ?></span><span><?php echo $userName; ?></span><span style="color:#6e789f">⌄</span></div></div></header>
    <section class="hero"><div><div class="crumbs"><span>测试</span><span>›</span><span>测试单详情</span></div><h1>测试单详情</h1><p class="subtitle">测试进度、用例执行表、缺陷联动和结果统计。</p></div><button class="ghost-btn">更多操作 ⌄</button></section>
    <section class="detail-layout"><div>
      <article class="detail-block"><div class="panel-head"><div><h2 class="panel-title">LucenAI 22.1 回归测试单</h2><p class="caption">测试编号 测试-2026-001 · 负责人 admin · 更新时间 2026-04-28</p></div><span class="status">进行中</span></div><div class="kv"><div class="kv-item"><div class="kv-label">进度</div><div class="kv-value">76%</div></div><div class="kv-item"><div class="kv-label">优先级</div><div class="kv-value">高</div></div><div class="kv-item"><div class="kv-label">截止日期</div><div class="kv-value">2026-05-18</div></div></div></article>
      <article class="detail-block rich"><h3>目标与范围</h3><p>该页面用于承载核心对象的完整信息。</p><h3>验收标准</h3><p>验收关注可读性、状态反馈和关联对象。</p><ul><li>关键路径清晰，状态变化可追踪。</li><li>表格、按钮、弹窗在深色背景下保持可读。</li><li>所有关联对象保留可进入详情的操作。</li></ul><h3>关联对象</h3><p>关联业务对象以表格和时间线呈现。</p></article>
