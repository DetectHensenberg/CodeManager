...
class commonModel extends model
{
   ...
   /**
     ...
     * @return array
     */
    public static function getHasPrivLink($menu)
    {
...
EOF;
     ...
     */
    public static function getWorkspaceInfo()
    {
        global $app, $config, $lang;

        if(isset($app->workspaceInfo)) return $app->workspaceInfo;

        if($config->vision != 'rnd' || !empty($config->noWorkspace) || (!empty($_SERVER['HTTP_USER_AGENT']) && strpos($_SERVER['HTTP_USER_AGENT'], 'xuanxuan') !== false))
        {
