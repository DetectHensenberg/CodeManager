...
class projectModel extends model
{
     ...
     * @return array
     */
    public function getAclListByObjectType($objectType, $account = '')
    {
     ...
     * @return array
     */
    public function getTeamListByType($type, $account = '')
    {
     ...
     * @return object|false
     */
    public function getPrivsByModel($model = 'waterfall', $projectID = 0, $hasProduct = 0)
    {
     ...
     * @return bool
    */
    public function hasFrozenObject($projectID, $category)
    {
