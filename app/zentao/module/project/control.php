...
class project extends control
{
     ...
     * @param int $useLink
     */
    public function ajaxGetDropMenu($projectID, $module = 'project', $method = 'index', $extra = '', $useLink = 1)
    {
    ...
    public function browse($programID = 0, $browseType = 'doing', $param = '', $orderBy = 'order_asc', $recTotal = 0, $recPerPage = 15, $pageID = 1)
    {
        ...
        $this->view->projectType   = $this->cookie->projectType && !commonModel::isTutorialMode() ? $this->cookie->projectType : 'bylist';
    ...
    public function create($model = 'scrum', $programID = 0, $copyProjectID = 0, $extra = '')
    {
        ...
        if($_POST)
        {
            ...
            if(!empty($_POST['products']) && $_POST['products'][0] != '') $_POST['hasProduct'] = '1';
     ...
     * @return void
     */
    public function testtask($projectID = 0, $productID = 0, $orderBy = 'id_desc', $recTotal = 0, $recPerPage = 20, $pageID = 1)
    {
     ...
     * @return void
     */
    public function managePriv($projectID, $groupID = 0, $type = 'byPackage')
    {
        $this->loadModel('group');
