    ...
    (
        ...
        (
            ...
            (
                ...
                div(setClass('flex gap-1 font-bold text-md'), !empty($menu['icon']) ? icon(setClass("svg-icon rounded-lg content-center bg-{$menu['bg']} text-white"), $menu['icon']) : img(set::src("static/svg/admin-{$menuKey}.svg")), $menu['name'], !empty($config->admin->helpURL[$menuKey]) ?
                a
                (
                    setClass('text-gray'),
