...
class dropmenu extends wg
{
     ...
     * @return array
     */
    public function buildSubDropMenu($module, $method, $tab, $objectID, $extra)
    {
        $app     = data('app');
        $subMenu = array();
     ...
     * @return object|null
     */
    public function buildBranchDropMenu($module, $method, $tab, $objectID, $extra)
    {
        $data       = $this->prop('data');
        $app        = data('app');
        $lang       = data('lang');
     ...
     * @return object|null
     */
    public function buildFlowGroupMenu($module, $method)
    {
        $data     = $this->prop('data');
        $app      = data('app');
