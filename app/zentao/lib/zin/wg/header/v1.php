...
CSS;
     ...
     */
    protected function buildWorkspaceHeader($workspace)
    {
        return h::header(setID('header'), commonModel::isTutorialMode() ? setStyle('min-width', 'fit-content') : null, $this->buildHeading());
    }
