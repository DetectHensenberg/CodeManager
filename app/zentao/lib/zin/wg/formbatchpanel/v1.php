...
.panel-form-batch .page-has-mainNavbar .form-batch-container {max-height: calc(100vh - 258px)}
...
CSS;
    ...
    public function children()
    {
        ...
        $children[] =  on::init()->do('$element.toggleClass("page-has-mainNavbar", !!$("#mainNavbar").length && !$element.closest(".modal-body").length)');
        return $children;
    }
}
