...
EOD;
    ...
    /**
     * {@inheritdoc}
     * @param \Box\Spout\Writer\Common\Entity\Worksheet $worksheet
     */
     ...
     * @return void
     */
    private function addNonEmptyRow($worksheet, $row)
    {
     ...
     * @return string
     */
    private function getCellXML($rowIndexOneBased, $columnIndexZeroBased, $cell, $styleId)
    {
