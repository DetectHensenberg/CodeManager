...
class WorksheetManager implements WorksheetManagerInterface
{
     ...
     * @return void
     */
    public function startSheet($worksheet)
    {
     ...
     */
    public function getTableElementStartAsString($worksheet)
    {
     ...
     * @return void
     */
    public function addRow($worksheet, $row)
    {
        $cells = $row->getCells();
     ...
     */
    private function applyStyleAndRegister($cell, $rowStyle)
    {
     ...
     */
    private function getCellXMLWithStyle($cell, $style, $currentCellIndex, $nextCellIndex)
    {
     ...
     */
    private function getCellXML($cell, $styleIndex, $numTimesValueRepeated)
    {
     ...
     * @return void
     */
    public function close($worksheet)
    {
