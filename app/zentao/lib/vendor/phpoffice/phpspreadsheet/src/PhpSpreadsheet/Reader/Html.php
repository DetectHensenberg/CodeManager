...
class Html extends BaseReader
{
     ...
     */
    protected function processDomElement($element, $sheet, &$row, &$column, &$cellContent)
    {
     ...
     * @return Spreadsheet
     */
    public function loadIntoExisting($pFilename, $spreadsheet)
    {
        // Validate
     ...
     */
    private function insertImage($sheet, $column, $row, $attributes)
    {
     ...
     * @param string $type
     */
    private function setBorderStyle($cellStyle, $styleValue, $type)
    {
