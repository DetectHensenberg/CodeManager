...
class StringTable extends WriterPart
{
     ...
     */
    public function createStringTable($pSheet, $pExistingTable = null)
    {
     ...
     */
    public function writeRichText($objWriter, $pRichText, $prefix = null)
    {
        if ($prefix !== null) {
            $prefix .= ':';
        }
     ...
     * @param string $prefix Optional Namespace prefix
     */
    public function writeRichTextForCharts($objWriter, $pRichText = null, $prefix = null)
    {
