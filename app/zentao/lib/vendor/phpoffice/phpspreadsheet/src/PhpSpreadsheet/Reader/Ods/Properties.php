...
class Properties
{
     ...
     */
    public function load($xml, $namespacesMeta)
    {
    ...
    /**
     * @param DocumentProperties $docProps
     * @param \SimpleXMLElement $officePropertyDC
     */
    private function setCoreProperties($docProps, $officePropertyDC)
    {
    ...
    /**
     * @param \SimpleXMLElement $propertyValue
     * @param DocumentProperties $docProps
     */
     ...
     * @param DocumentProperties $docProps
     */
    private function setUserDefinedProperty($propertyValueAttributes, $propertyValue, $docProps)
    {
        $propertyValueName = '';
