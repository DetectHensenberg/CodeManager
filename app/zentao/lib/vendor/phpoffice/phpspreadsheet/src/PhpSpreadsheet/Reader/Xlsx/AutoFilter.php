...
class AutoFilter
{
     ...
     */
    public function __construct($workSheet, $worksheetXml)
    {
     ...
     * @param \PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column $column
     */
    private function readDateRangeAutoFilter($filters, $column)
    {
    ...
    /**
     * @param \SimpleXMLElement $filterColumn
     * @param \PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column $column
     */
    private function readCustomAutoFilter($filterColumn, $column)
    {
     ...
     * @param \PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column $column
     */
    private function readDynamicAutoFilter($filterColumn, $column)
    {
     ...
     * @param \PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column $column
     */
    private function readTopTenAutoFilter($filterColumn, $column)
    {
