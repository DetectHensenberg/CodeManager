...
class Styles extends BaseParserClass
{
    ...
    /**
     * @param \SimpleXMLElement $styleXml
     */
    public function __construct($styleXml)
    {
        $this->styleXml = $styleXml;
    }

    /**
     * @param \PhpOffice\PhpSpreadsheet\Reader\Xlsx\Theme|null $theme
     */
    ...
    /**
     * @param \PhpOffice\PhpSpreadsheet\Style\Font $fontStyle
     * @param \SimpleXMLElement $fontStyleXml
     */
    private static function readFontStyle($fontStyle, $fontStyleXml)
    {
    ...
    /**
     * @param \PhpOffice\PhpSpreadsheet\Style\Fill $fillStyle
     * @param \SimpleXMLElement $fillStyleXml
     */
    private static function readFillStyle($fillStyle, $fillStyleXml)
    {
    ...
    /**
     * @param \PhpOffice\PhpSpreadsheet\Style\Borders $borderStyle
     * @param \SimpleXMLElement $borderStyleXml
     */
    private static function readBorderStyle($borderStyle, $borderStyleXml)
    {
    ...
    /**
     * @param \PhpOffice\PhpSpreadsheet\Style\Border $border
     * @param \SimpleXMLElement $borderXml
     */
    private static function readBorder($border, $borderXml)
    {
    ...
    /**
     * @param \PhpOffice\PhpSpreadsheet\Style\Alignment $alignment
     * @param \SimpleXMLElement $alignmentXml
     */
    private static function readAlignmentStyle($alignment, $alignmentXml)
    {
    ...
    /**
     * @param \PhpOffice\PhpSpreadsheet\Style\Style $docStyle
     */
    private function readStyle($docStyle, $style)
    {
     ...
     * @param \PhpOffice\PhpSpreadsheet\Style\Style $docStyle
     */
    private function readProtectionLocked($docStyle, $style)
    {
     ...
     * @param \PhpOffice\PhpSpreadsheet\Style\Style $docStyle
     */
    private function readProtectionHidden($docStyle, $style)
    {
