...
class Worksheet implements IComparable
{
     ...
     *
     * @param \PhpOffice\PhpSpreadsheet\Spreadsheet|null $parent
     * @param string $pTitle
     */
     ...
     * @return Chart
     */
    public function addChart($pChart, $iChartIndex = null)
    {
     ...
     * @return Worksheet
     */
    public function duplicateStyle($pCellStyle, $pRange)
    {
     ...
     * @return Worksheet
     */
    public function duplicateConditionalStyle($pCellStyle, $pRange = '')
    {
     ...
     * @return Worksheet
     */
    public function fromArray($source, $nullValue = null, $startCell = 'A1', $strictNullComparison = false)
    {
