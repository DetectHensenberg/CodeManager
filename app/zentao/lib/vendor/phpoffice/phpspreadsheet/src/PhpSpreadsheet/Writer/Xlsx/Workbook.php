...
class Workbook extends WriterPart
{
     ...
     */
    public function writeWorkbook($spreadsheet, $recalcRequired = false)
    {
        // Create XML writer
     ...
     */
    private function writeFileVersion($objWriter)
    {
     ...
     * @param XMLWriter $objWriter XML Writer
     */
    private function writeWorkbookPr($objWriter)
    {
     ...
     * @param Spreadsheet $spreadsheet
     */
    private function writeBookViews($objWriter, $spreadsheet)
    {
        // bookViews
     ...
     * @param Spreadsheet $spreadsheet
     */
    private function writeWorkbookProtection($objWriter, $spreadsheet)
    {
     ...
     * @param bool $recalcRequired Indicate whether formulas should be recalculated before writing
     */
    private function writeCalcPr($objWriter, $recalcRequired = true)
    {
     ...
     * @throws WriterException
     */
    private function writeSheets($objWriter, $spreadsheet)
    {
        // Write sheets
     ...
     * @throws WriterException
     */
    private function writeSheet($objWriter, $pSheetname, $pSheetId = 1, $pRelId = 1, $sheetState = 'visible')
    {
        if ($pSheetname != '') {
            // Write sheet
     ...
     * @throws WriterException
     */
    private function writeDefinedNames($objWriter, $spreadsheet)
    {
        // Write defined names
     ...
     * @throws WriterException
     */
    private function writeNamedRanges($objWriter, $spreadsheet)
    {
        // Loop named ranges
     ...
     */
    private function writeDefinedNameForNamedRange($objWriter, $pNamedRange)
    {
     ...
     * @param int $pSheetId
     */
    private function writeDefinedNameForAutofilter($objWriter, $pSheet, $pSheetId = 0)
    {
        // definedName for autoFilter
     ...
     * @param int $pSheetId
     */
    private function writeDefinedNameForPrintTitles($objWriter, $pSheet, $pSheetId = 0)
    {
     ...
     * @param int $pSheetId
     */
    private function writeDefinedNameForPrintArea($objWriter, $pSheet, $pSheetId = 0)
    {
