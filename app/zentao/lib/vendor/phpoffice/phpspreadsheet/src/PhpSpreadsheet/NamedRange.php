...
class NamedRange
{
     ...
     * @throws Exception
     */
    public function __construct($pName, $pWorksheet, $pRange = 'A1', $pLocalOnly = false, $pScope = null)
    {
        // Validate data
     ...
     * @param \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $pSheet Scope. Use null for global scope
     *
     * @return NamedRange
     */
