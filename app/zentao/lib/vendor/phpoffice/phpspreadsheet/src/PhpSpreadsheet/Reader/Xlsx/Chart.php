...
class Chart
{
    ...
    /**
     * @param \SimpleXMLElement $titleDetails
     * @param mixed[] $namespacesChartMeta
     */
    private static function chartTitle($titleDetails, $namespacesChartMeta)
    {
        $caption = [];
        $titleLayout = null;
    ...
    /**
     * @param \SimpleXMLElement $titleDetailPart
     */
