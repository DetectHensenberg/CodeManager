...
class Worksheet extends WriterPart
{
     ...
     */
    public function writeWorksheet($pSheet, $pStringTable = null, $includeCharts = false)
    {
        // Create XML writer
        $objWriter = null;
     ...
     */
    private function writeSheetPr($objWriter, $pSheet)
    {
        // sheetPr
     ...
     * @param PhpspreadsheetWorksheet $pSheet Worksheet
     */
    private function writeDimension($objWriter, $pSheet)
    {
        // dimension
     ...
     * @throws WriterException
     */
    private function writeSheetViews($objWriter, $pSheet)
    {
        // sheetViews
     ...
     * @param PhpspreadsheetWorksheet $pSheet Worksheet
     */
    private function writeSheetFormatPr($objWriter, $pSheet)
    {
        // sheetFormatPr
     ...
     * @param PhpspreadsheetWorksheet $pSheet Worksheet
     */
    private function writeCols($objWriter, $pSheet)
    {
        // cols
     ...
     * @param PhpspreadsheetWorksheet $pSheet Worksheet
     */
    private function writeSheetProtection($objWriter, $pSheet)
    {
        // sheetProtection
     ...
     * @throws WriterException
     */
    private function writeConditionalFormatting($objWriter, $pSheet)
    {
        // Conditional id
        $id = 1;
     ...
     * @param PhpspreadsheetWorksheet $pSheet Worksheet
     */
    private function writeDataValidations($objWriter, $pSheet)
    {
     ...
     * @param PhpspreadsheetWorksheet $pSheet Worksheet
     */
    private function writeHyperlinks($objWriter, $pSheet)
    {
     ...
     * @param PhpspreadsheetWorksheet $pSheet Worksheet
     */
    private function writeProtectedRanges($objWriter, $pSheet)
    {
     ...
     * @param PhpspreadsheetWorksheet $pSheet Worksheet
     */
    private function writeMergeCells($objWriter, $pSheet)
    {
     ...
     * @param PhpspreadsheetWorksheet $pSheet Worksheet
     */
    private function writePrintOptions($objWriter, $pSheet)
    {
        // printOptions
     ...
     * @param PhpspreadsheetWorksheet $pSheet Worksheet
     */
    private function writePageMargins($objWriter, $pSheet)
    {
        // pageMargins
     ...
     * @param PhpspreadsheetWorksheet $pSheet Worksheet
     */
    private function writeAutoFilter($objWriter, $pSheet)
    {
        $autoFilterRange = $pSheet->getAutoFilter()->getRange();
        if (!empty($autoFilterRange)) {
            // autoFilter
     ...
     * @param PhpspreadsheetWorksheet $pSheet Worksheet
     */
    private function writePageSetup($objWriter, $pSheet)
    {
        // pageSetup
     ...
     * @param PhpspreadsheetWorksheet $pSheet Worksheet
     */
    private function writeHeaderFooter($objWriter, $pSheet)
    {
        // headerFooter
     ...
     * @param PhpspreadsheetWorksheet $pSheet Worksheet
     */
    private function writeBreaks($objWriter, $pSheet)
    {
     ...
     * @throws WriterException
     */
    private function writeSheetData($objWriter, $pSheet, $pStringTable)
    {
     ...
     * @throws WriterException
     */
    private function writeCell($objWriter, $pSheet, $pCellAddress, $pFlippedStringTable)
    {
        // Cell
     ...
     */
    private function writeDrawings($objWriter, $pSheet, $includeCharts = false)
    {
     ...
     * @param PhpspreadsheetWorksheet $pSheet Worksheet
     */
    private function writeLegacyDrawing($objWriter, $pSheet)
    {
     ...
     * @param PhpspreadsheetWorksheet $pSheet Worksheet
     */
    private function writeLegacyDrawingHF($objWriter, $pSheet)
    {
     ...
     * @param PhpspreadsheetWorksheet $pSheet
     */
    private function writeAlternateContent($objWriter, $pSheet)
    {
