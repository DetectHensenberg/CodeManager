...
class SheetViewOptions extends BaseParserClass
{
    ...
    /**
     * @param \SimpleXMLElement $sheetPr
     */
    private function tabColor($sheetPr)
    {
     ...
     * @param \SimpleXMLElement $sheetPr
     */
    private function codeName($sheetPr)
    {
     ...
     * @param \SimpleXMLElement $sheetPr
     */
    private function outlines($sheetPr)
    {
     ...
     * @param \SimpleXMLElement $sheetPr
     */
    private function pageSetup($sheetPr)
    {
    ...
    /**
     * @param \SimpleXMLElement $sheetFormatPr
     */
    private function sheetFormat($sheetFormatPr)
    {
    ...
    /**
     * @param \SimpleXMLElement $printOptions
     */
    private function printOptions($printOptions)
    {
