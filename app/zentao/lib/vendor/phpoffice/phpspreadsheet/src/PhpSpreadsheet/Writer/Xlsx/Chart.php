...
class Chart extends WriterPart
{
     ...
     */
    public function writeChart($pChart, $calculateCellValues = true)
    {
     ...
     * @param \PhpOffice\PhpSpreadsheet\Chart\Title|null $title
     *
     * @throws WriterException
     */
    private function writeTitle($objWriter, $title = null)
    {
        if ($title === null) {
            return;
        }
     ...
     *
     * @param XMLWriter $objWriter XML Writer
     * @param \PhpOffice\PhpSpreadsheet\Chart\Legend|null $legend
     *
     * @throws WriterException
     */
    private function writeLegend($objWriter, $legend = null)
    {
        if ($legend === null) {
            return;
        }
     ...
     * @param \PhpOffice\PhpSpreadsheet\Chart\Title|null $xAxisLabel
     * @param \PhpOffice\PhpSpreadsheet\Chart\Title|null $yAxisLabel
     * @param \PhpOffice\PhpSpreadsheet\Chart\Axis|null $xAxis
     * @param \PhpOffice\PhpSpreadsheet\Chart\Axis|null $yAxis
     * @param null|GridLines $majorGridlines
     * @param null|GridLines $minorGridlines
     *
     * @throws WriterException
     */
    private function writePlotArea($objWriter, $pSheet, $plotArea, $xAxisLabel = null, $yAxisLabel = null, $xAxis = null, $yAxis = null, $majorGridlines = null, $minorGridlines = null)
    {
        if ($plotArea === null) {
            return;
        }
     ...
     */
    private function writeDataLabels($objWriter, $chartLayout = null)
    {
     ...
     *
     * @param XMLWriter $objWriter XML Writer
     * @param \PhpOffice\PhpSpreadsheet\Chart\Layout|null $layout
     */
    private function writeLayout($objWriter, $layout = null)
    {
