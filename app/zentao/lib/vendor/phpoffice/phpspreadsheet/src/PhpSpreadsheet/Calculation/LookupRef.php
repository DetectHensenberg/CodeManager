...
class LookupRef
{
     ...
     * @param \PhpOffice\PhpSpreadsheet\Cell\Cell|null $pCell The cell to set the hyperlink in
     *
     ...
     * @param \PhpOffice\PhpSpreadsheet\Cell\Cell|null $pCell The current cell (containing this formula)
     *
