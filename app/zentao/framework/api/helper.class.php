...
class helper extends baseHelper
{
     ...
     * @return string
     */
    public static function createLink($moduleName, $methodName = 'index', $vars = '', $viewType = 'json', $onlyBody = false)
    {
        global $config;
     ...
     * @return string
     */
    static public function send($data = '', $code = 200)
    {
     ...
     * @return string
     */
    static public function response($data = '', $code = 200)
    {
        $statusCode = array(
            100 => "100 Continue",
